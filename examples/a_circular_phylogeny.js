(function () {
    ...
    var tree_df = radialLayout(readTree(treestring));

    var width = 700,
        height = 700;
    
    // these parameters need individual tweaking, not sure where I am going wrong here...
    var scale = 0.2,
        constant = 275,
        edge_scale = scale*constant*32
    ...
    group.append("g")
        ...
        .data(tree_df.arcs)
        .join("path")
        .attr("d", d => describeArc(xScale(0), yScale(0), d.radius * edge_scale, d.start, d.end))
        .attr('fill-opacity', '0')
        .attr("class", "path")
        .attr("stroke", "#777")
